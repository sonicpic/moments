...
type BackgroundMusicVO struct {
	URL       string `json:"url,omitempty"`       //音频地址
	Title     string `json:"title,omitempty"`     //曲目标题
	LyricsURL string `json:"lyricsUrl,omitempty"` //歌词文件地址
	Lyrics    string `json:"lyrics,omitempty"`    //歌词内容，用于避免跨域读取歌词文件失败
	FileName  string `json:"fileName,omitempty"`  //原始文件名，用于匹配同名歌词
}
...
type SysConfigVO struct {
	...
	EnableLike              bool                `json:"enableLike"`                        //是否允许普通访客点赞
	ShowVisitorLikeCount    bool                `json:"showVisitorLikeCount"`              //普通访客是否可查看点赞数
	EnableComment           bool                `json:"enableComment"`                     //是否允许普通访客评论
	ShowVisitorComments     bool                `json:"showVisitorComments"`               //普通访客是否可查看评论
	ShowVisitorInteractions bool                `json:"showVisitorInteractions,omitempty"` //旧版互动总开关，兼容历史配置
	...
	EnableBackgroundMusic   bool                `json:"enableBackgroundMusic"`             //是否启用背景音乐
	BackgroundMusicUrl      string              `json:"backgroundMusicUrl,omitempty"`      //背景音乐地址
	BackgroundMusicTitle    string              `json:"backgroundMusicTitle,omitempty"`    //背景音乐标题
	...
	ProfileLinkURL          string              `json:"profileLinkUrl,omitempty"`          //点击头像和昵称时跳转的自定义链接
